---
title: 'Developer FAQ'
description: 'Common SDK and REST API integration questions, answered.'
icon: 'circle-question'
---

_Questions about agentic commerce, merchants, or refunds? See the
[Agentic Commerce FAQs](/integration/faqs). CLI issues? See
[Prava Pay Troubleshooting](/prava-pay/troubleshooting)._
...
e.g. a **sandbox** session opened on the **prod** collect host (or vice-versa). This is **not** a
domain-allowlist problem — a disallowed origin returns `403`, not `404`.
