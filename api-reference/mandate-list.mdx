---
title: 'List Mandates'
description: 'List the standing mandates on an account, with approved and remaining amounts.'
icon: 'list'
openapi: '/api-reference/openapi.json GET /v1/mandates'
...
<ResponseField name="mandates" type="object[]">
  <Expandable title="mandate properties">
    ...
    <ResponseField name="state" type="string">Display-derived usability: `available`, `consumed`, `expired`, `paused`, `cancelled`, or `pending`.</ResponseField>
