---
title: 'REST Checkout Walkthrough'
description: 'The complete payment flow with nothing but cURL — hosted card entry, zero frontend code.'
icon: 'terminal'
---
...
`card_id` is the source of truth for the card bound to the transaction, whether it was preselected
or chosen by the cardholder.
