---
title: 'Add Payments to Your AI App'
description: 'The end-to-end tutorial: from a fresh dashboard account to a completed, reported payment inside your own application.'
...
async function getCredentials(sessionId: string) {
  ...
  const li = transaction.line_items[0];
  return {
    cardId: transaction.card_id, // source-of-truth card bound to this transaction
