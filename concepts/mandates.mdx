---
title: 'Mandates'
description: 'Standing spend authorizations — approve once with a passkey, let an agent charge later within caps.'
icon: 'shield-check'
---
...
| **REST API** | Server-side charge, reporting, and lifecycle management | [Charge a mandate](/api-reference/mandate-charge) |
